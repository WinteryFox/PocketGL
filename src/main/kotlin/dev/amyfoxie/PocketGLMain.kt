...
fun main() {
    Window(300, 300, true).use { window ->
        ...
        //val kindred =
        //    Model.from(PocketGLMain::class.java.getResourceAsStream("/models/kindred/scene.gltf") ?: error("Ohno"))
        val kindred = Model.from(PocketGLMain::class.java.getResourceAsStream("/models/kindred/scene.gltf")!!)
        kindred.translate(-0.5f, -2f, -4.25f)
